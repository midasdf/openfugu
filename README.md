...
`:where`, `:pwd`, `:worktrees`, `:git`, `:changed`, `:remote`, `:branch`, `:branches`, `:log`, `:diff`, `:staged`, `:patch`, `:ci`, `:watch-ci`, `:pr`, `:pr <number-or-url>`, `:pr-checkout <number-or-url>`, `:issues`, `:issue <number-or-url>`, `:verify`, `:build`, `:test`, `:fmt`, `:check`, `:fetch`, `:pull`, `:push`, `:stash`, `:stash-pop`, `:cancel`,
