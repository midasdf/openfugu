...
`:where`, `:pwd`, `:worktrees`, `:git`, `:changed`, `:remote`, `:branch`, `:branches`, `:log`, `:diff`, `:staged`, `:staged-patch`, `:patch`, `:ci`, `:watch-ci`, `:pr`, `:pr <number-or-url>`, `:pr-checkout <number-or-url>`, `:issues`, `:issue <number-or-url>`, `:verify`, `:build`, `:test`, `:fmt`, `:check`, `:fetch`, `:pull`, `:push`, `:push-force-with-lease`, `:stash`, `:stashes`, `:stash-show`, `:stash-patch`, `:stash-pop`, `:cancel`,
