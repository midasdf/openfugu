...
test "interactive input classifies prompt lines" {
    ...
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.changed, openfugu.cli.interactiveInput(":changed\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.remote, openfugu.cli.interactiveInput(":remote\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.branch, openfugu.cli.interactiveInput(":branch\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.branches, openfugu.cli.interactiveInput(":branches\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.tags, openfugu.cli.interactiveInput(":tags\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.describe, openfugu.cli.interactiveInput(":describe\n"));
    ...
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.staged_patch, openfugu.cli.interactiveInput(":staged-patch\n"));
    ...
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.pr, openfugu.cli.interactiveInput(":pr\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.issues, openfugu.cli.interactiveInput(":issues\n"));
    ...
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.push_force_with_lease, openfugu.cli.interactiveInput(":push-force-with-lease\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.stash, openfugu.cli.interactiveInput(":stash\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.stashes, openfugu.cli.interactiveInput(":stashes\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.stash_show, openfugu.cli.interactiveInput(":stash-show\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.stash_patch, openfugu.cli.interactiveInput(":stash-patch\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.stash_pop, openfugu.cli.interactiveInput(":stash-pop\n"));
    ...
    try std.testing.expectEqualStrings("update tui command", openfugu.cli.interactiveInput(":commit-amend update tui command\n").commit_amend);
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.commit_amend_no_edit, openfugu.cli.interactiveInput(":commit-amend-no-edit\n"));
    try std.testing.expectEqualStrings("feature/tui", openfugu.cli.interactiveInput(":switch feature/tui\n").switch_branch);
    try std.testing.expectEqualStrings("feature/new", openfugu.cli.interactiveInput(":new-branch feature/new\n").new_branch);
    try std.testing.expectEqualStrings("HEAD", openfugu.cli.interactiveInput(":show HEAD\n").show);
    try std.testing.expectEqualStrings("12", openfugu.cli.interactiveInput(":issue 12\n").issue);
    try std.testing.expectEqualStrings("34", openfugu.cli.interactiveInput(":pr 34\n").pr_view);
    try std.testing.expectEqualStrings("34", openfugu.cli.interactiveInput(":pr-checkout 34\n").pr_checkout);
    ...
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.plan_last, openfugu.cli.interactiveInput(":plan\n"));
    try std.testing.expectEqualStrings("fix failing tests", openfugu.cli.interactiveInput(":route fix failing tests\n").route);
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.route_last, openfugu.cli.interactiveInput(":route\n"));
    ...
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.unknown_command, openfugu.cli.interactiveInput(":save\n"));
    try std.testing.expectEqual(openfugu.cli.InteractiveInput.unknown_command, openfugu.cli.interactiveInput(":nope\n"));
}
